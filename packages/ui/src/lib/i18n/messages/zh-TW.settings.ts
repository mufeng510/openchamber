...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.providers.page.custom.models.discovery.fetch': '取得模型',
  'settings.providers.page.custom.models.discovery.fetching': '正在取得模型...',
  'settings.providers.page.custom.models.discovery.empty': '供應商未傳回任何模型。',
  'settings.providers.page.custom.models.discovery.requiresBaseURL': '取得模型前，請輸入有效的 http:// 或 https:// 基礎 URL。',
  'settings.providers.page.custom.models.discovery.selection': '已選取 {selected} / {total}',
  'settings.providers.page.custom.models.discovery.selectAll': '全選',
  'settings.providers.page.custom.models.discovery.clearSelection': '清除選取',
  'settings.providers.page.custom.models.discovery.selectModel': '選取 {name}',
  'settings.providers.page.custom.models.discovery.addSelected': '新增所選的 {count} 個',
  'settings.providers.page.custom.models.discovery.error.invalidURL': '此基礎 URL 不是有效的 http:// 或 https:// 位址。',
  'settings.providers.page.custom.models.discovery.error.urlBlocked': '此位址不允許用於模型探索。',
  'settings.providers.page.custom.models.discovery.error.authFailed': '驗證失敗。請檢查 API 金鑰或已儲存的認證。',
  'settings.providers.page.custom.models.discovery.error.accessDenied': '供應商拒絕了目前認證的存取。',
  'settings.providers.page.custom.models.discovery.error.endpointNotFound': '在此基礎 URL 下找不到模型清單。請檢查 URL 是否有拼寫錯誤。',
  'settings.providers.page.custom.models.discovery.error.rateLimited': '供應商正在限制請求頻率。請稍後重試。',
  'settings.providers.page.custom.models.discovery.error.badResponse': '供應商未傳回有效的模型清單。',
  'settings.providers.page.custom.models.discovery.error.providerError': '供應商傳回了錯誤。請檢查基礎 URL 和 API 協定。',
  'settings.providers.page.custom.models.discovery.error.redirect': '供應商重新導向了請求。請使用能直接回應的基礎 URL。',
  'settings.providers.page.custom.models.discovery.error.network': '無法連線到供應商。請檢查基礎 URL 和網路連線。',
  'settings.providers.page.custom.models.discovery.error.timeout': '供應商未回應。請確認其可連線後再重試。',
  'settings.providers.page.custom.models.discovery.error.failed': '模型探索失敗。請檢查基礎 URL 後重試。',
