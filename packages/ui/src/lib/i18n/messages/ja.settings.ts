...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.providers.page.custom.models.discovery.fetch': 'モデルを取得',
  'settings.providers.page.custom.models.discovery.fetching': 'モデルを取得中...',
  'settings.providers.page.custom.models.discovery.empty': 'プロバイダーはモデルを返しませんでした。',
  'settings.providers.page.custom.models.discovery.requiresBaseURL': 'モデルを取得する前に、有効な http:// または https:// のベース URL を入力してください。',
  'settings.providers.page.custom.models.discovery.selection': '{total} 件中 {selected} 件を選択',
  'settings.providers.page.custom.models.discovery.selectAll': 'すべて選択',
  'settings.providers.page.custom.models.discovery.clearSelection': '選択をクリア',
  'settings.providers.page.custom.models.discovery.selectModel': '{name} を選択',
  'settings.providers.page.custom.models.discovery.addSelected': '選択中の {count} 件を追加',
  'settings.providers.page.custom.models.discovery.error.invalidURL': 'このベース URL は有効な http:// または https:// アドレスではありません。',
  'settings.providers.page.custom.models.discovery.error.urlBlocked': 'このアドレスはモデル検出には許可されていません。',
  'settings.providers.page.custom.models.discovery.error.authFailed': '認証に失敗しました。API キーまたは保存済みの認証情報を確認してください。',
  'settings.providers.page.custom.models.discovery.error.accessDenied': '現在の認証情報ではプロバイダーがアクセスを拒否しました。',
  'settings.providers.page.custom.models.discovery.error.endpointNotFound': 'このベース URL にモデル一覧が見つかりませんでした。URL に誤字がないか確認してください。',
  'settings.providers.page.custom.models.discovery.error.rateLimited': 'プロバイダーがリクエストを制限しています。少し待ってから再試行してください。',
  'settings.providers.page.custom.models.discovery.error.badResponse': 'プロバイダーが有効なモデル一覧を返しませんでした。',
  'settings.providers.page.custom.models.discovery.error.providerError': 'プロバイダーがエラーを返しました。ベース URL と API プロトコルを確認してください。',
  'settings.providers.page.custom.models.discovery.error.redirect': 'プロバイダーがリクエストをリダイレクトしました。直接応答するベース URL を使用してください。',
  'settings.providers.page.custom.models.discovery.error.network': 'プロバイダーに接続できませんでした。ベース URL と接続を確認してください。',
  'settings.providers.page.custom.models.discovery.error.timeout': 'プロバイダーが応答しませんでした。到達可能か確認して再試行してください。',
  'settings.providers.page.custom.models.discovery.error.failed': 'モデルの検出に失敗しました。ベース URL を確認して再試行してください。',
