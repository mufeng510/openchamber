...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.providers.page.custom.models.discovery.fetch': '获取模型',
  'settings.providers.page.custom.models.discovery.fetching': '正在获取模型...',
  'settings.providers.page.custom.models.discovery.empty': '该供应商未返回任何模型。',
  'settings.providers.page.custom.models.discovery.requiresBaseURL': '获取模型前请输入有效的 http:// 或 https:// 基础 URL。',
  'settings.providers.page.custom.models.discovery.selection': '已选择 {selected} / {total}',
  'settings.providers.page.custom.models.discovery.selectAll': '全选',
  'settings.providers.page.custom.models.discovery.clearSelection': '清除选择',
  'settings.providers.page.custom.models.discovery.selectModel': '选择 {name}',
  'settings.providers.page.custom.models.discovery.addSelected': '添加所选 {count} 个',
  'settings.providers.page.custom.models.discovery.error.invalidURL': '此基础 URL 不是有效的 http:// 或 https:// 地址。',
  'settings.providers.page.custom.models.discovery.error.urlBlocked': '不允许使用此地址进行模型发现。',
  'settings.providers.page.custom.models.discovery.error.authFailed': '身份验证失败。请检查 API 密钥或已保存的凭据。',
  'settings.providers.page.custom.models.discovery.error.accessDenied': '供应商拒绝了当前凭据的访问。',
  'settings.providers.page.custom.models.discovery.error.endpointNotFound': '在此基础 URL 下未找到模型列表。请检查 URL 是否有拼写错误。',
  'settings.providers.page.custom.models.discovery.error.rateLimited': '供应商正在限制请求频率。请稍后重试。',
  'settings.providers.page.custom.models.discovery.error.badResponse': '供应商未返回有效的模型列表。',
  'settings.providers.page.custom.models.discovery.error.providerError': '供应商返回了错误。请检查基础 URL 和 API 协议。',
  'settings.providers.page.custom.models.discovery.error.redirect': '供应商重定向了请求。请使用直接响应的基础 URL。',
  'settings.providers.page.custom.models.discovery.error.network': '无法连接到供应商。请检查基础 URL 和网络连接。',
  'settings.providers.page.custom.models.discovery.error.timeout': '供应商未响应。请确认其可访问后重试。',
  'settings.providers.page.custom.models.discovery.error.failed': '模型发现失败。请检查基础 URL 后重试。',
