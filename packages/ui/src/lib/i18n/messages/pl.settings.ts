...
export const settingsDict = {
  ...
  'settings.providers.page.custom.models.discovery.fetch': 'Pobierz modele',
  'settings.providers.page.custom.models.discovery.fetching': 'Pobieranie modeli...',
  'settings.providers.page.custom.models.discovery.empty': 'Dostawca nie zwrócił żadnych modeli.',
  'settings.providers.page.custom.models.discovery.requiresBaseURL': 'Podaj prawidłowy adres bazowy http:// lub https:// przed pobraniem modeli.',
  'settings.providers.page.custom.models.discovery.selection': 'Wybrano {selected} z {total}',
  'settings.providers.page.custom.models.discovery.selectAll': 'Zaznacz wszystkie',
  'settings.providers.page.custom.models.discovery.clearSelection': 'Wyczyść zaznaczenie',
  'settings.providers.page.custom.models.discovery.selectModel': 'Zaznacz {name}',
  'settings.providers.page.custom.models.discovery.addSelected': 'Dodaj wybrane ({count})',
  'settings.providers.page.custom.models.discovery.error.invalidURL': 'Ten adres bazowy nie jest prawidłowym adresem http:// ani https://.',
  'settings.providers.page.custom.models.discovery.error.urlBlocked': 'Ten adres jest niedozwolony dla wykrywania modeli.',
  'settings.providers.page.custom.models.discovery.error.authFailed': 'Uwierzytelnienie nie powiodło się. Sprawdź klucz API lub zapisane poświadczenia.',
  'settings.providers.page.custom.models.discovery.error.accessDenied': 'Dostawca odmówił dostępu przy użyciu bieżących poświadczeń.',
  'settings.providers.page.custom.models.discovery.error.endpointNotFound': 'Nie znaleziono listy modeli pod tym adresem bazowym. Sprawdź adres pod kątem literówek.',
  'settings.providers.page.custom.models.discovery.error.rateLimited': 'Dostawca ogranicza liczbę żądań. Poczekaj chwilę i spróbuj ponownie.',
  'settings.providers.page.custom.models.discovery.error.badResponse': 'Dostawca nie zwrócił prawidłowej listy modeli.',
  'settings.providers.page.custom.models.discovery.error.providerError': 'Dostawca zwrócił błąd. Sprawdź adres bazowy i protokół API.',
  'settings.providers.page.custom.models.discovery.error.redirect': 'Dostawca przekierował żądanie. Użyj adresu bazowego, który odpowiada bezpośrednio.',
  'settings.providers.page.custom.models.discovery.error.network': 'Nie można połączyć się z dostawcą. Sprawdź adres bazowy i połączenie.',
  'settings.providers.page.custom.models.discovery.error.timeout': 'Dostawca nie odpowiedział. Sprawdź, czy jest osiągalny, i spróbuj ponownie.',
  'settings.providers.page.custom.models.discovery.error.failed': 'Wykrywanie modeli nie powiodło się. Sprawdź adres bazowy i spróbuj ponownie.',
