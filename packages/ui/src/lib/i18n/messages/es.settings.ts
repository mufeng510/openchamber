...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.providers.page.custom.models.discovery.fetch": "Obtener modelos",
  "settings.providers.page.custom.models.discovery.fetching": "Obteniendo modelos...",
  "settings.providers.page.custom.models.discovery.empty": "El proveedor no devolvió ningún modelo.",
  "settings.providers.page.custom.models.discovery.requiresBaseURL": "Introduce una URL base http:// o https:// válida antes de obtener modelos.",
  "settings.providers.page.custom.models.discovery.selection": "{selected} de {total} seleccionados",
  "settings.providers.page.custom.models.discovery.selectAll": "Seleccionar todos",
  "settings.providers.page.custom.models.discovery.clearSelection": "Borrar selección",
  "settings.providers.page.custom.models.discovery.selectModel": "Seleccionar {name}",
  "settings.providers.page.custom.models.discovery.addSelected": "Añadir {count} seleccionados",
  "settings.providers.page.custom.models.discovery.error.invalidURL": "Esta URL base no es una dirección http:// o https:// válida.",
  "settings.providers.page.custom.models.discovery.error.urlBlocked": "Esta dirección no está permitida para la obtención de modelos.",
  "settings.providers.page.custom.models.discovery.error.authFailed": "Error de autenticación. Comprueba la clave de API o las credenciales guardadas.",
  "settings.providers.page.custom.models.discovery.error.accessDenied": "El proveedor denegó el acceso con las credenciales actuales.",
  "settings.providers.page.custom.models.discovery.error.endpointNotFound": "La lista de modelos no se encontró en esta URL base. Revisa si hay errores tipográficos.",
  "settings.providers.page.custom.models.discovery.error.rateLimited": "El proveedor está limitando las solicitudes. Espera un momento e inténtalo de nuevo.",
  "settings.providers.page.custom.models.discovery.error.badResponse": "El proveedor no devolvió una lista de modelos válida.",
  "settings.providers.page.custom.models.discovery.error.providerError": "El proveedor devolvió un error. Comprueba la URL base y el protocolo de API.",
  "settings.providers.page.custom.models.discovery.error.redirect": "El proveedor redirigió la solicitud. Usa una URL base que responda directamente.",
  "settings.providers.page.custom.models.discovery.error.network": "No se pudo contactar con el proveedor. Comprueba la URL base y tu conexión.",
  "settings.providers.page.custom.models.discovery.error.timeout": "El proveedor no respondió. Comprueba que está disponible y vuelve a intentarlo.",
  "settings.providers.page.custom.models.discovery.error.failed": "No se pudieron obtener los modelos. Comprueba la URL base e inténtalo de nuevo.",
