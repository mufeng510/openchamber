...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.providers.page.custom.models.discovery.fetch": "Отримати моделі",
  "settings.providers.page.custom.models.discovery.fetching": "Отримання моделей...",
  "settings.providers.page.custom.models.discovery.empty": "Провайдер не повернув жодної моделі.",
  "settings.providers.page.custom.models.discovery.requiresBaseURL": "Введіть дійсну базову URL-адресу http:// або https://, перш ніж отримувати моделі.",
  "settings.providers.page.custom.models.discovery.selection": "Вибрано {selected} із {total}",
  "settings.providers.page.custom.models.discovery.selectAll": "Вибрати все",
  "settings.providers.page.custom.models.discovery.clearSelection": "Очистити вибір",
  "settings.providers.page.custom.models.discovery.selectModel": "Вибрати {name}",
  "settings.providers.page.custom.models.discovery.addSelected": "Додати вибрані ({count})",
  "settings.providers.page.custom.models.discovery.error.invalidURL": "Ця базова URL-адреса не є дійсною адресою http:// або https://.",
  "settings.providers.page.custom.models.discovery.error.urlBlocked": "Ця адреса заборонена для виявлення моделей.",
  "settings.providers.page.custom.models.discovery.error.authFailed": "Помилка автентифікації. Перевірте ключ API або збережені облікові дані.",
  "settings.providers.page.custom.models.discovery.error.accessDenied": "Провайдер відхилив доступ з поточними обліковими даними.",
  "settings.providers.page.custom.models.discovery.error.endpointNotFound": "Список моделей не знайдено за цією базовою URL-адресою. Перевірте URL-адресу на наявність друкарських помилок.",
  "settings.providers.page.custom.models.discovery.error.rateLimited": "Провайдер обмежує кількість запитів. Зачекайте трохи та спробуйте знову.",
  "settings.providers.page.custom.models.discovery.error.badResponse": "Провайдер не повернув дійсний список моделей.",
  "settings.providers.page.custom.models.discovery.error.providerError": "Провайдер повернув помилку. Перевірте базову URL-адресу та протокол API.",
  "settings.providers.page.custom.models.discovery.error.redirect": "Провайдер перенаправив запит. Використовуйте базову URL-адресу, яка відповідає безпосередньо.",
  "settings.providers.page.custom.models.discovery.error.network": "Не вдалося зв'язатися з провайдером. Перевірте базову URL-адресу та підключення.",
  "settings.providers.page.custom.models.discovery.error.timeout": "Провайдер не відповів. Перевірте, чи він доступний, і повторіть спробу.",
  "settings.providers.page.custom.models.discovery.error.failed": "Не вдалося виявити моделі. Перевірте базову URL-адресу та повторіть спробу.",
