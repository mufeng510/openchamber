...
export const settingsDict = {
  ...
  'settings.providers.page.custom.models.discovery.fetch': 'Récupérer les modèles',
  'settings.providers.page.custom.models.discovery.fetching': 'Récupération des modèles...',
  'settings.providers.page.custom.models.discovery.empty': 'Le fournisseur n\'a renvoyé aucun modèle.',
  'settings.providers.page.custom.models.discovery.requiresBaseURL': 'Saisissez une URL de base http:// ou https:// valide avant de récupérer les modèles.',
  'settings.providers.page.custom.models.discovery.selection': '{selected} sur {total} sélectionnés',
  'settings.providers.page.custom.models.discovery.selectAll': 'Tout sélectionner',
  'settings.providers.page.custom.models.discovery.clearSelection': 'Effacer la sélection',
  'settings.providers.page.custom.models.discovery.selectModel': 'Sélectionner {name}',
  'settings.providers.page.custom.models.discovery.addSelected': 'Ajouter {count} sélectionnés',
  'settings.providers.page.custom.models.discovery.error.invalidURL': 'Cette URL de base n\'est pas une adresse http:// ou https:// valide.',
  'settings.providers.page.custom.models.discovery.error.urlBlocked': 'Cette adresse n\'est pas autorisée pour la découverte de modèles.',
  'settings.providers.page.custom.models.discovery.error.authFailed': 'Échec de l\'authentification. Vérifiez la clé API ou les identifiants enregistrés.',
  'settings.providers.page.custom.models.discovery.error.accessDenied': 'Le fournisseur a refusé l\'accès avec les identifiants actuels.',
  'settings.providers.page.custom.models.discovery.error.endpointNotFound': 'La liste des modèles est introuvable à cette URL de base. Vérifiez les fautes de frappe.',
  'settings.providers.page.custom.models.discovery.error.rateLimited': 'Le fournisseur limite les requêtes. Attendez un instant puis réessayez.',
  'settings.providers.page.custom.models.discovery.error.badResponse': 'Le fournisseur n\'a pas renvoyé une liste de modèles valide.',
  'settings.providers.page.custom.models.discovery.error.providerError': 'Le fournisseur a renvoyé une erreur. Vérifiez l\'URL de base et le protocole d\'API.',
  'settings.providers.page.custom.models.discovery.error.redirect': 'Le fournisseur a redirigé la requête. Utilisez une URL de base qui répond directement.',
  'settings.providers.page.custom.models.discovery.error.network': 'Impossible de joindre le fournisseur. Vérifiez l\'URL de base et votre connexion.',
  'settings.providers.page.custom.models.discovery.error.timeout': 'Le fournisseur n\'a pas répondu. Vérifiez qu\'il est accessible puis réessayez.',
  'settings.providers.page.custom.models.discovery.error.failed': 'La découverte des modèles a échoué. Vérifiez l\'URL de base et réessayez.',
