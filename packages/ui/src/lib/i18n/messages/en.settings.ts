...
export const settingsDict = {
  ...
  'settings.providers.page.custom.models.discovery.fetch': 'Fetch models',
  'settings.providers.page.custom.models.discovery.fetching': 'Fetching models...',
  'settings.providers.page.custom.models.discovery.empty': 'The provider returned no models.',
  'settings.providers.page.custom.models.discovery.requiresBaseURL': 'Enter a valid http:// or https:// Base URL before fetching models.',
  'settings.providers.page.custom.models.discovery.selection': '{selected} of {total} selected',
  'settings.providers.page.custom.models.discovery.selectAll': 'Select all',
  'settings.providers.page.custom.models.discovery.clearSelection': 'Clear selection',
  'settings.providers.page.custom.models.discovery.selectModel': 'Select {name}',
  'settings.providers.page.custom.models.discovery.addSelected': 'Add {count} selected',
  'settings.providers.page.custom.models.discovery.error.invalidURL': 'This Base URL is not a valid http:// or https:// address.',
  'settings.providers.page.custom.models.discovery.error.urlBlocked': 'This address is not allowed for model discovery.',
  'settings.providers.page.custom.models.discovery.error.authFailed': 'Authentication failed. Check the API key or stored credentials.',
  'settings.providers.page.custom.models.discovery.error.accessDenied': 'The provider refused access with the current credentials.',
  'settings.providers.page.custom.models.discovery.error.endpointNotFound': 'The model list was not found at this Base URL. Check the URL for typos.',
  'settings.providers.page.custom.models.discovery.error.rateLimited': 'The provider is rate-limiting requests. Wait a moment and try again.',
  'settings.providers.page.custom.models.discovery.error.badResponse': 'The provider did not return a valid model list.',
  'settings.providers.page.custom.models.discovery.error.providerError': 'The provider returned an error. Check the Base URL and API protocol.',
  'settings.providers.page.custom.models.discovery.error.redirect': 'The provider redirected the request. Use a Base URL that answers directly.',
  'settings.providers.page.custom.models.discovery.error.network': 'Could not reach the provider. Check the Base URL and your connection.',
  'settings.providers.page.custom.models.discovery.error.timeout': 'The provider did not respond. Check that it is reachable, then try again.',
  'settings.providers.page.custom.models.discovery.error.failed': 'Model discovery failed. Check the Base URL and try again.',
