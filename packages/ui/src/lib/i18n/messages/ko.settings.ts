...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.providers.page.custom.models.discovery.fetch': '모델 가져오기',
  'settings.providers.page.custom.models.discovery.fetching': '모델 가져오는 중...',
  'settings.providers.page.custom.models.discovery.empty': '공급자가 모델을 반환하지 않았습니다.',
  'settings.providers.page.custom.models.discovery.requiresBaseURL': '모델을 가져오기 전에 유효한 http:// 또는 https:// 기본 URL을 입력하세요.',
  'settings.providers.page.custom.models.discovery.selection': '총 {total}개 중 {selected}개 선택됨',
  'settings.providers.page.custom.models.discovery.selectAll': '모두 선택',
  'settings.providers.page.custom.models.discovery.clearSelection': '선택 해제',
  'settings.providers.page.custom.models.discovery.selectModel': '{name} 선택',
  'settings.providers.page.custom.models.discovery.addSelected': '선택한 {count}개 추가',
  'settings.providers.page.custom.models.discovery.error.invalidURL': '이 기본 URL은 유효한 http:// 또는 https:// 주소가 아닙니다.',
  'settings.providers.page.custom.models.discovery.error.urlBlocked': '이 주소는 모델 검색에 허용되지 않습니다.',
  'settings.providers.page.custom.models.discovery.error.authFailed': '인증에 실패했습니다. API 키 또는 저장된 자격 증명을 확인하세요.',
  'settings.providers.page.custom.models.discovery.error.accessDenied': '공급자가 현재 자격 증명으로 액세스를 거부했습니다.',
  'settings.providers.page.custom.models.discovery.error.endpointNotFound': '이 기본 URL에서 모델 목록을 찾을 수 없습니다. URL의 오타를 확인하세요.',
  'settings.providers.page.custom.models.discovery.error.rateLimited': '공급자가 요청을 제한하고 있습니다. 잠시 기다렸다가 다시 시도하세요.',
  'settings.providers.page.custom.models.discovery.error.badResponse': '공급자가 유효한 모델 목록을 반환하지 않았습니다.',
  'settings.providers.page.custom.models.discovery.error.providerError': '공급자가 오류를 반환했습니다. 기본 URL과 API 프로토콜을 확인하세요.',
  'settings.providers.page.custom.models.discovery.error.redirect': '공급자가 요청을 리디렉션했습니다. 직접 응답하는 기본 URL을 사용하세요.',
  'settings.providers.page.custom.models.discovery.error.network': '공급자에 연결할 수 없습니다. 기본 URL과 연결을 확인하세요.',
  'settings.providers.page.custom.models.discovery.error.timeout': '공급자가 응답하지 않았습니다. 연결 가능한지 확인한 후 다시 시도하세요.',
  'settings.providers.page.custom.models.discovery.error.failed': '모델 검색에 실패했습니다. 기본 URL을 확인하고 다시 시도하세요.',
