...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.providers.page.custom.models.discovery.fetch": "Buscar modelos",
  "settings.providers.page.custom.models.discovery.fetching": "Buscando modelos...",
  "settings.providers.page.custom.models.discovery.empty": "O provedor não retornou nenhum modelo.",
  "settings.providers.page.custom.models.discovery.requiresBaseURL": "Digite uma URL base http:// ou https:// válida antes de buscar modelos.",
  "settings.providers.page.custom.models.discovery.selection": "{selected} de {total} selecionados",
  "settings.providers.page.custom.models.discovery.selectAll": "Selecionar todos",
  "settings.providers.page.custom.models.discovery.clearSelection": "Limpar seleção",
  "settings.providers.page.custom.models.discovery.selectModel": "Selecionar {name}",
  "settings.providers.page.custom.models.discovery.addSelected": "Adicionar {count} selecionados",
  "settings.providers.page.custom.models.discovery.error.invalidURL": "Esta URL base não é um endereço http:// ou https:// válido.",
  "settings.providers.page.custom.models.discovery.error.urlBlocked": "Este endereço não é permitido para descoberta de modelos.",
  "settings.providers.page.custom.models.discovery.error.authFailed": "Falha na autenticação. Verifique a chave de API ou as credenciais salvas.",
  "settings.providers.page.custom.models.discovery.error.accessDenied": "O provedor negou o acesso com as credenciais atuais.",
  "settings.providers.page.custom.models.discovery.error.endpointNotFound": "A lista de modelos não foi encontrada nesta URL base. Verifique se há erros de digitação.",
  "settings.providers.page.custom.models.discovery.error.rateLimited": "O provedor está limitando as solicitações. Aguarde um momento e tente novamente.",
  "settings.providers.page.custom.models.discovery.error.badResponse": "O provedor não retornou uma lista de modelos válida.",
  "settings.providers.page.custom.models.discovery.error.providerError": "O provedor retornou um erro. Verifique a URL base e o protocolo da API.",
  "settings.providers.page.custom.models.discovery.error.redirect": "O provedor redirecionou a solicitação. Use uma URL base que responda diretamente.",
  "settings.providers.page.custom.models.discovery.error.network": "Não foi possível alcançar o provedor. Verifique a URL base e sua conexão.",
  "settings.providers.page.custom.models.discovery.error.timeout": "O provedor não respondeu. Verifique se está acessível e tente novamente.",
  "settings.providers.page.custom.models.discovery.error.failed": "Falha ao buscar modelos. Verifique a URL base e tente novamente.",
